...
- **Veo** (Google DeepMind, May 2024) — **1080p minute-long text-to-video** with cinematic camera control; Google's flagship video model and the bar Veo 2/3 build on. [[Blog](https://deepmind.google/discover/blog/veo/)] [[Website](https://deepmind.google/models/veo/)]
- **1X World Model** (1X Technologies, Sep 2024) — **Action-conditioned humanoid forecaster** predicts full-body humanoid futures from video for evaluating policies in "bits, not atoms". [[Blog](https://www.1x.tech/discover/1x-world-model)] [[Tech Report](https://www.1x.tech/1x-world-model.pdf)]
...
- **Veo 2** (Google DeepMind, Dec 2024) — **4K resolution + improved physics**; stronger object permanence and motion realism, exceeded Sora benchmarks at launch. [[Blog](https://blog.google/technology/google-labs/video-image-generation-update-december-2024/)] [[Website](https://deepmind.google/models/veo/)]
- **Genesis** (Multi-institution collab, Dec 2024) — **43M FPS generative physics engine**; rigid + MPM + SPH + FEM + PBD fluid solvers in one Pythonic API, generates 4D worlds from natural language. [[Website](https://genesis-embodied-ai.github.io/)] [[Code](https://github.com/Genesis-Embodied-AI/Genesis)]
...
- **Veo 3** (Google DeepMind, May 2025) — **Native synchronized audio**; first major text-to-video to jointly generate dialogue, music, and ambient sound aligned with frames in one pass. [[Blog](https://deepmind.google/discover/blog/veo-3/)] [[Website](https://deepmind.google/models/veo/)]
...
- **Odyssey-2** (Odyssey, Oct 2025) — **20 FPS streaming interactive video** via multi-stage causal training; first general-purpose model to imagine interactive video instantly from text prompts. [[Blog](https://odyssey.ml/introducing-odyssey-2)]
...
- **Veo 3.1** (Google DeepMind, Oct 2025) — **Narrative control + clip extension**; preserves subject, outfit, and camera continuity when extending clips beyond their original length. [[Blog](https://developers.googleblog.com/introducing-veo-3-1-and-new-creative-capabilities-in-the-gemini-api/)] [[Website](https://deepmind.google/models/veo/)]
...
- **Lucy 2.0** (Decart, Jan 2026) — **Sub-100ms real-time world transformation**; 30 fps 1080p live video editing via mega-kernel optimized diffusion with smart history augmentation against drift. [[Blog](https://decart.ai/publications/lucy-2-introducing-sota-video-generation-in-realtime)] [[Website](https://lucy.decart.ai/)]
- **Happy Oyster** ![New](https://img.shields.io/badge/-New-brightgreen) (Alibaba, Apr 2026) — **Directing + wandering modes**; natively multimodal world model with joint audio-video, mid-generation steering via text/voice/image, first-person WASD exploration. [[Website](https://happyoyster.lol)]
- **Odyssey-2 Max** ![New](https://img.shields.io/badge/-New-brightgreen) (Odyssey, May 2026) — **SOTA physics via next-state prediction** at scale; highest physics score among evaluated real-time world models while streaming interactively. [[Blog](https://odyssey.ml/introducing-odyssey-2-max)]
...
- **LaWM** ![New](https://img.shields.io/badge/-New-brightgreen) (May 2026) — **Least-Action world models**; future rollouts governed by a learned Lagrangian action functional for long-horizon physical consistency. [[Paper](https://arxiv.org/abs/2605.08279)]
...
- **Matrix-Game 3.0** ![New](https://img.shields.io/badge/-New-brightgreen) (Skywork, Apr 2026) — **40 FPS 720p with minute-long memory** in a 5B model; long-horizon consistency for streaming interactive game generation. [[Paper](https://arxiv.org/abs/2604.08995)]
- **SCOPE** ![New](https://img.shields.io/badge/-New-brightgreen) (May 2026) — **Spatially-selective FPS world model**; per-pixel conditioning module so weapon-local events (fire/reload) don't disrupt the broader scene; CrossFPS dataset spans 7 titles with frame-aligned 10-DoF controller signals for cross-game generalization. [[Paper](https://arxiv.org/abs/2605.23345)] [[Website](https://z2tong.github.io/SCOPE/)] [[Code](https://github.com/z2tong/SCOPE)]
- **Agora-1** ![New](https://img.shields.io/badge/-New-brightgreen) (Odyssey, May 2026) — First **playable multi-agent world model**; four humans/AIs share one generated deathmatch scene with shared state streamed per-player. [[Blog](https://odyssey.ml/introducing-agora-1)]
...
- **HY-World 2.0** ![New](https://img.shields.io/badge/-New-brightgreen) (Tencent, Apr 2026) — **Editable persistent 3D assets, not pixels**; four-stage pipeline (HY-Pano-2.0 → WorldNav → WorldStereo 2.0 → WorldMirror 2.0) outputs mesh/3DGS importable into Unity/Unreal/Isaac Sim. [[Paper](https://arxiv.org/abs/2604.14268)] [[Code](https://github.com/Tencent-Hunyuan/HY-World-2.0)]
...
- **Lyra 2.0** ![New](https://img.shields.io/badge/-New-brightgreen) (NVIDIA, Apr 2026) — **Persistent explorable 3D worlds from one image** with self-augmented histories against temporal drift; exports to 3DGS/mesh for Isaac Sim. [[Paper](https://arxiv.org/abs/2604.13036)] [[Website](https://research.nvidia.com/labs/sil/projects/lyra2/)] [[Code](https://huggingface.co/nvidia/Lyra-2.0)]
- **Spark 2.0** ![New](https://img.shields.io/badge/-New-brightgreen) (World Labs, Apr 2026) — **Open-source 3DGS streaming renderer** with LOD streaming; renders 100M+ Gaussians in any browser. [[Blog](https://www.worldlabs.ai/blog/spark-2.0)]
